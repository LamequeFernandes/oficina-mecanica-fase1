...
from app.modules.orcamento.presentation.routes import router as router_orcamento
...
app.include_router(router_ordem_servico, prefix='/veiculos', tags=['Ordem de Serviço'])
app.include_router(router_orcamento, prefix='/veiculos/ordem-servico', tags=['Orçamento'])
