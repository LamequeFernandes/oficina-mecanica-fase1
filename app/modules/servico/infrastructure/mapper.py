from ..domain.entities import TipoServico, Servico
from ..application.dto import TipoServicoOutDTO, ServicoOutDTO
from .models import TipoServicoModel, ServicoModel
...
class ServicoMapper:
    ...
    def entity_to_model(servico: Servico) -> ServicoModel:
        return ServicoModel(
            ...
            tipo_servico_id=servico.tipo_servico.tipo_servico_id,
    ...
    def entity_to_output_dto(servico: Servico) -> ServicoOutDTO:
        return ServicoOutDTO(
            servico_id=servico.servico_id,
            tipo_servico=TipoServicoMapper.entity_to_output_dto(servico.tipo_servico),
            valor_servico=servico.valor_servico,
            orcamento_id=servico.orcamento_id,
        )
