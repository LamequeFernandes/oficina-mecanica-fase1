...
class OrdemServicoModel(Base):
    ...
    veiculo_id = Column(Integer, ForeignKey('veiculo.veiculo_id'), nullable=False)
    status = Column(
        Enum(
    ...
    orcamento = relationship("OrcamentoModel", back_populates="ordem_servico", uselist=False)
