...
class UsuarioModel(Base):
    ...
    funcionario = relationship("FuncionarioModel", back_populates="usuario", uselist=False)
...
class ClienteModel(Base):
    ...
    tipo_cliente = Column(Enum('PF', 'PJ', name='tipo_cliente'), nullable=False)
...
class FuncionarioModel(Base):
    ...
    tipo_funcionario = Column(Enum('ADMINISTRADOR', 'MECANICO', name='tipo_funcionario'), nullable=False)
