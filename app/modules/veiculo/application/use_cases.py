...
from app.core.exceptions import ApenasFuncionariosProprietariosError, ValorDuplicadoError, VeiculoNotFoundError
...
class AlterarVeiculoUseCase:
    ...
    def execute(self, veiculo_id: int, dados: VeiculoInputDTO) -> VeiculoOutputDTO:
        veiculo = self.repo.buscar_por_id(veiculo_id)
